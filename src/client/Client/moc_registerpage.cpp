...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RegisterPage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 85, 32)
    ...
    "RegisterPage\0on_btn_registerConfirm_clicked\0"
    "\0on_btn_ping_clicked\0on_btn_back_clicked\0"
    "on_txt_username_selectionChanged\0"
};
...
void RegisterPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RegisterPage *_t = static_cast<RegisterPage *>(_o);
        switch (_id) {
        case 0: _t->on_btn_registerConfirm_clicked(); break;
        case 1: _t->on_btn_ping_clicked(); break;
        case 2: _t->on_btn_back_clicked(); break;
        case 3: _t->on_txt_username_selectionChanged(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject RegisterPage::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_RegisterPage.data,
      qt_meta_data_RegisterPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RegisterPage.stringdata))
